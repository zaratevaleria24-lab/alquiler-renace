...
export const HUBS: Hub[] = [
  ...
  { slug: 'servicios', titulo: 'Servicios en Isla de Margarita: agua, supermercados, farmacias, taxis', h1: ['Lo que vas a necesitar', 'durante tu estadía'], categorias: ['supermercado', 'licores', 'agua', 'salud', 'transporte', 'practico'],
    ...
    intro: ['Vivir unos días en la isla tiene su logística: el agua se compra en botellón, la luz a veces se va, y conviene saber qué farmacia abre de noche y a quién llamar para un taxi seguro. Esto es lo que resolvemos por nuestros huéspedes y ahora dejamos por escrito para todos.',
      'Los que llevan sello dorado son aliados que pasaron nuestro filtro: precio transparente e igual para todos, respuesta inmediata por WhatsApp, negocio local, y salen del catálogo si dos huéspedes reportan informalidad. Cada sello dice para qué: Caribest Water y Recargas La Perla para el agua, V2 Aventuras para moverte, Ketchup Hot para desayunar, Rafa\'s Casual Food para hamburguesas, Guuao para beber algo. El de traslados es nuestro. Si algo falla en el apartamento, primero escríbenos: casi siempre lo resolvemos nosotros.'] },
