...
export const PAGINAS: PaginaIntencion[] = [
  {
    ...
    secciones: [
      ...
      { titulo: 'Cuánto cuesta y cómo se paga', parrafos: ['US$65 la noche en los cuatro, para hasta 6 personas. Se paga en dólares (Zelle, Binance/USDT, efectivo) o en bolívares por pago móvil a la tasa USDT del día. Confirmas con el 50 % y firmas el contrato de hospedaje desde tu teléfono; el saldo, al llegar.'] },
    ],
    faq: [
