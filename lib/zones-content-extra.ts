...
export const ZONE_EXTRA: Record<string, string[]> = {
  ...
  porlamar: [
    ...
    'No tenemos apartamento dentro del casco de Porlamar: el más cercano es Agua Mar, en Playa El Ángel (Pampatar), a 10 minutos en carro del centro: apartamento frente a la playa con piscina, con tarifa y capacidad en su ficha y enlace a las reseñas de Airbnb.',
  ...
  'costa-azul': [
    ...
    'Nuestros apartamentos están en Pampatar, no en Costa Azul. Puedes comparar Agua Mar en Playa El Ángel, Bahía Mágica en La Caranta y las dos opciones de Los Geranios. Revisa sus ubicaciones en el mapa y confirma el trayecto que necesitas antes de reservar.',
  ...
  'playa-caribe': [
    ...
    'No hay oferta de apartamentos nuestros aquí; es zona de excursión de día desde Pampatar, donde puedes consultar nuestros apartamentos y sus tarifas actuales. Con carro alquilado (DG Automóviles entrega en el apartamento) o con nuestro traslado por día se hace cómodo.',
  ],
  'playa-parguito': [
  ...
  'playa-guacuco': [
    ...
    'Es una excelente playa de «medio día» para quien se aloja con nosotros en Pampatar: sales a las 8, te bañas cuando el sol todavía es amable, comes guacuco y pescado, y a las 2 estás de vuelta en la piscina del apartamento. Puedes consultar la ubicación y la tarifa actual de nuestros apartamentos de Pampatar en sus fichas.',
