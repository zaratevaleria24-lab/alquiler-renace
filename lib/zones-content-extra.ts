...
export const ZONE_EXTRA: Record<string, string[]> = {
  ...
  porlamar: [
    ...
    'No tenemos apartamento dentro del casco de Porlamar: el más cercano es Agua Mar, en Playa El Ángel (Pampatar), a 10 minutos en carro del centro: penthouse con piscina en la azotea y vista al mar, US$60 la noche para hasta 6 personas, valoración 4.8 en Airbnb.',
  ...
  'costa-azul': [
    ...
    'Nuestro apartamento más cercano a Costa Azul es Bahía Mágica, en La Caranta (Pampatar), a 5 minutos: conjunto cerrado con piscina y áreas verdes, US$60 la noche para hasta 6 personas, valoración 5.0 en Airbnb. Desde ahí, el Castillo de Pampatar queda a 5 minutos, el aeropuerto a 25 y Playa El Agua a 35.',
  ...
  'playa-caribe': [
    ...
    'No hay oferta de apartamentos nuestros aquí; es zona de excursión de día desde Pampatar, Pampatar, donde sí tenemos hospedaje a US$60 la noche. Con carro alquilado (DG Automóviles entrega en el apartamento) o con nuestro traslado por día se hace cómodo.',
  ],
  'playa-parguito': [
