...
export const ZONE_EXTRA: Record<string, string[]> = {
  ...
  porlamar: [
    ...
    'No tenemos apartamento dentro del casco de Porlamar: el más cercano es Agua Mar, en Playa El Ángel (Pampatar), a 10 minutos en carro del centro: penthouse con piscina en la azotea y vista al mar, US$65 la noche para hasta 6 personas, valoración 4.8 en Airbnb.',
