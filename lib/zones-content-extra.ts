...
export const ZONE_EXTRA: Record<string, string[]> = {
  pampatar: [
    ...
    'Nuestros apartamentos en Pampatar —Los Geranios A y Los Geranios · Depto de lujo— están en la urbanización Los Geranios: conjunto cerrado con vigilancia, piscina, cancha y parque infantil, a 5 minutos del Sambil. Cuestan US$60 la noche para hasta 6 personas, en dólares o en bolívares a la tasa USDT del día, con contrato de hospedaje firmado desde el teléfono.',
  ...
  porlamar: [
    ...
    'Nuestro apartamento en Porlamar es Agua Mar: penthouse con piscina en la azotea y vista a la ciudad y al mar, US$60 la noche para hasta 6 personas, con valoración 4.8 en Airbnb. Queda a distancia de caminar de las tiendas del centro y a 10 minutos en carro de Costa Azul y Pampatar.',
  ...
  'costa-azul': [
    ...
    'Bahía Mágica, nuestro apartamento en Costa Azul, está en un conjunto cerrado con piscina y áreas verdes: US$60 la noche para hasta 6 personas, valoración 5.0 en Airbnb. Desde ahí, el Castillo de Pampatar queda a 7 minutos, el aeropuerto a 25 y Playa El Agua a 35.',
  ...
  'playa-caribe': [
    ...
    'No hay oferta de apartamentos nuestros aquí; es zona de excursión de día desde Pampatar, Costa Azul o Porlamar, donde sí tenemos alojamiento a US$60 la noche. Con carro alquilado (DG Automóviles entrega en el apartamento) o con nuestro traslado por día se hace cómodo.',
  ],
  'playa-parguito': [
    ...
    'No tenemos apartamentos propios en Parguito. Nuestros huéspedes surfistas se quedan en Pampatar (Los Geranios) o Costa Azul (Bahía Mágica) y vienen en carro por la mañana, cuando el mar está más ordenado. Playa El Agua, con cuatro kilómetros de restaurantes, queda a 5 minutos para almorzar.',
  ],
  'playa-guacuco': [
    ...
    'Es una excelente playa de «medio día» para quien se aloja con nosotros en Pampatar o Porlamar: sales a las 8, te bañas cuando el sol todavía es amable, comes guacuco y pescado, y a las 2 estás de vuelta en la piscina del apartamento. Nuestros apartamentos quedan a 20 minutos y cuestan US$60 la noche.',
