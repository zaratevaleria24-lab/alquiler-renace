...
export interface ZoneCopy {
  ...
  headline: string;
  /** 1-2 frases para meta description. Sin relleno. */
  summary: string;
  /** Párrafos de contexto real de la zona. */
  body: string[];
  /** Referencias cercanas concretas. */
  nearby: string[];
  /** Para quién encaja esta zona. */
  bestFor: string;
  /** Costa/orientación — dato útil y diferenciador. */
  coast: string;
}

export const ZONE_COPY: Record<string, ZoneCopy> = {
  pampatar: {
    headline: 'Pampatar',
    summary:
...
export const DEFAULT_ZONE_COPY: Omit<ZoneCopy, 'headline'> = {
  summary:
