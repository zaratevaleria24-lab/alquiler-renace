...
export const LUGARES: Semilla[] = [
  ...
  { nombre: 'Sigo Supermarket', categoria: 'supermercado', busqueda: 'Sigo Supermarket Costa Azul Porlamar', municipio: 'Mariño',
    ...
    consejo: 'La sede de Costa Azul es la más cómoda si te alojás en Pampatar o Costa Azul. Después de las 7 de la tarde hay menos cola.', mejorMomento: 'Mañana o después de las 19', duracion: '', costo: '' },
  { nombre: 'Río Supermarket', categoria: 'supermercado', busqueda: 'Rio Supermarket Porlamar', municipio: 'Mariño',
    ...
    consejo: 'Para una compra grande al llegar, es la mejor relación surtido-precio. Pedí factura si pagás en dólares: te dan el vuelto en bolívares a la tasa del día.', mejorMomento: 'Mañana', duracion: '', costo: '' },
  { nombre: 'Al Costo Market', categoria: 'supermercado', busqueda: 'Al Costo Market Margarita', instagram: 'alcostomgta', municipio: 'Mariño',
    ...
    consejo: 'Revisá su Instagram antes de ir: las ofertas de quincena valen la pena para una estadía larga.', mejorMomento: 'Quincena', duracion: '', costo: '' },
  { nombre: 'Guuao Marketplace', categoria: 'licores', busqueda: 'GUUAO MARKETPLACE MARGARITA', municipio: 'Maneiro',
    ...
    consejo: 'Si querés llevarte ron de regalo, acá está la mejor selección de Santa Teresa, Diplomático y Pampero.', mejorMomento: '', duracion: '', costo: '' },
  ...
  { nombre: 'El Abuelo Pachanguero — licores a domicilio', categoria: 'licores', busqueda: 'El Abuelo Pachanguero licores Margarita', instagram: 'elabuelopachangueromgta', municipio: 'Mariño',
    descripcion: 'Licorería con delivery en Porlamar, Pampatar y Costa Azul: pedís por Instagram o WhatsApp y te lo llevan al apartamento, con hielo.',
    consejo: 'Pedí antes de las 9 de la noche los fines de semana; después se satura. Preguntá si tienen hielo y vasos.', mejorMomento: 'Tarde', duracion: '', costo: 'Delivery según zona' },
  { nombre: 'Pizzería El Paseo — delivery', categoria: 'delivery', busqueda: 'Pizzeria El Paseo Porlamar', municipio: 'Mariño',
    ...
    consejo: 'Los viernes y sábados demora más de una hora: pedí temprano.', mejorMomento: 'Noche', duracion: '', costo: 'Delivery según zona' },
  { nombre: "Bro's Venezuela — hamburguesas", categoria: 'delivery', busqueda: "Bro's Venezuela Snack Burger Margarita", municipio: 'Mariño',
    ...
    consejo: 'Pedí por WhatsApp directo: suele ser más rápido que por apps.', mejorMomento: 'Noche', duracion: '', costo: 'Delivery según zona' },
  { nombre: 'TequeDun — tequeños y pasapalos', categoria: 'delivery', busqueda: 'TequeDun Margarita', instagram: 'tequedun', municipio: 'Mariño',
    ...
    consejo: 'Ideal para la llegada: pedís desde el aeropuerto y comés al entrar. Encargá con unas horas.', mejorMomento: 'Tarde', duracion: '', costo: 'Delivery según zona' },
  { nombre: 'Yummy — delivery y transporte', categoria: 'delivery', busqueda: 'Yummy Venezuela app', web: 'https://yummysuperapp.com/', municipio: '',
    ...
    consejo: 'Descargala antes de viajar y registrá tu tarjeta: es la forma más fácil de pedir comida y moverte sin efectivo.', mejorMomento: '', duracion: '', costo: 'Según pedido' },
  { nombre: 'Agua La Fuente — botellones a domicilio', categoria: 'agua', busqueda: 'Agua la Fuente Margarita', municipio: 'Mariño',
    ...
    consejo: 'Pedí el botellón con dispensador al llegar: el agua del grifo en la isla no es para tomar. Guardá el envase, se cambia por uno lleno.', mejorMomento: 'Mañana', duracion: '', costo: 'Botellón + depósito del envase' },
  { nombre: 'Freskagua', categoria: 'agua', busqueda: 'Freskagua Margarita', municipio: 'Mariño',
    ...
    consejo: 'Preguntá el horario de reparto de tu zona: suelen tener días fijos.', mejorMomento: '', duracion: '', costo: 'Botellón' },
  { nombre: 'Tu Cisterna Margarita — camión de agua', categoria: 'agua', busqueda: 'Cisterna agua Margarita camión', instagram: 'tucisternamargarita', municipio: '',
    ...
    consejo: 'Esto lo coordina el anfitrión, no el huésped: si notás que el tanque baja, avisanos por WhatsApp y nosotros lo pedimos.', mejorMomento: '', duracion: '', costo: 'Por viaje' },
  { nombre: 'Servibombas Margarita — gas', categoria: 'agua', busqueda: 'Servibombas Margarita gas', municipio: 'Mariño',
    ...
    consejo: 'Igual que el agua: si se acaba el gas, escribinos y lo resolvemos nosotros. No manipules la bombona.', mejorMomento: '', duracion: '', costo: 'Por bombona' },
  ...
  { nombre: 'Farmacia El Crucero', categoria: 'salud', busqueda: 'Farmacia El Crucero Margarita', instagram: 'farmaciaelcrucero.mgta', municipio: 'Mariño',
    ...
    consejo: 'Si necesitás una medicina con receta y no querés salir, escribiles: mandan a domicilio.', mejorMomento: '', duracion: '', costo: 'Delivery según zona' },
  { nombre: 'Hospital Clínicas del Este', categoria: 'salud', busqueda: 'Hospital Clínicas del Este Porlamar', municipio: 'Mariño',
    ...
    consejo: 'Guardá el número antes de necesitarlo. Emergencias nacionales: 911. Para una consulta menor, primero preguntanos: te orientamos.', mejorMomento: '', duracion: '', costo: 'Privada' },
  { nombre: 'Centro Clínico del Caribe', categoria: 'salud', busqueda: 'Centro Clínico del Caribe Porlamar', municipio: 'Mariño',
    ...
    consejo: 'Llevá pasaporte o cédula y, si tenés seguro de viaje, el número de póliza.', mejorMomento: '', duracion: '', costo: 'Privada' },
  { nombre: 'Ridery — carros por app', categoria: 'transporte', busqueda: 'Ridery Venezuela', web: 'https://ridery.app/', municipio: '',
    ...
    consejo: 'Es la forma más segura de moverte de noche. Registrá la tarjeta antes de viajar; con datos móviles funciona sin problema.', mejorMomento: '', duracion: '', costo: 'Según trayecto' },
  { nombre: 'Central Taxi Costa Azul', categoria: 'transporte', busqueda: 'Central Taxi Costa Azul Margarita', municipio: 'Mariño',
    ...
    consejo: 'Acordá el precio antes de subir. Del aeropuerto a Costa Azul son unos 20 minutos.', mejorMomento: '', duracion: '', costo: 'Según trayecto' },
  { nombre: 'DG Automóviles — alquiler de carros', categoria: 'transporte', busqueda: 'Dg Automoviles Car Rental Margarita', municipio: 'Mariño',
    ...
    consejo: 'Para ir a Macanao, La Restinga o Punta Arenas conviene carro. Reservá con días de anticipación en temporada.', mejorMomento: '', duracion: '', costo: 'Por día' },
  { nombre: 'Traslados y autos de Margarita Renace', categoria: 'transporte', busqueda: 'Margarita Renace traslados aeropuerto Isla de Margarita', web: 'https://margaritarenace.com.ve/autos', municipio: '',
    ...
    consejo: 'Escribinos con tu hora de llegada y te esperamos con el nombre en un cartel. Sin regatear a la salida del aeropuerto.', mejorMomento: '', duracion: '', costo: 'Precio cerrado por WhatsApp' },
];
