...
export default async function PoliticasPage() {
  ...
  const secciones: [string, string[]][] = [
    ['Reserva y pago', [`Reservas directo por WhatsApp o en /reservas, o por Airbnb si prefieres su protección. El precio se expresa en dólares; si pagas en bolívares se calcula al BCV del día del pago; si pagas en USDT, al equivalente del día (tasa Binance). Te lo informamos por escrito.`, 'Para confirmar, un anticipo (normalmente el 50 %) por Zelle, Binance/USDT, pago móvil o efectivo; el saldo, al ingresar. Recibes un contrato de hospedaje para firmar desde tu teléfono antes de llegar.']],
