    ...
    <>
      ...
      <div className="min-h-screen bg-paper">
        <header className="bg-luz border-b border-line"><div className="max-w-5xl mx-auto px-5 pb-8 pt-24 md:px-8 md:pt-28">
          ...
          <p className="mt-4 max-w-2xl text-body text-ink-soft">Elige apartamento y fechas: te decimos el total en dólares y en bolívares a la tasa USDT de hoy, si las fechas están libres, y te llevamos al WhatsApp con todo escrito. Te responde una persona.</p>
        </div></header>
