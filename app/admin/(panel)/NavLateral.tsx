...
const NAV = [
  ...
  { href: '/admin/guia', label: 'Guía turística', icono: Compass, listo: true },
  { href: '/admin/contratos', label: 'Contratos', icono: FileSignature, listo: true },
  { href: '/admin/plantillas', label: 'Plantillas de Instagram', icono: LayoutTemplate, listo: true },
  { href: '/admin/contactos', label: 'Contactos (CRM)', icono: Users, listo: true },
